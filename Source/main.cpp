...
int main(int argc, char **argv)
{
    ...
    Sleep(8000);
    //launch game
    oID = "com.epicgames.launcher://apps/0bef9383794a4d779ba0628084b14cba%3A14a33650f001420fa2abc8e925e6a139%3A261f8e875a0e45f98e517946deca4dc8?action=launch&silent=true";
    Start(oID, NULL);
    for (int i = 1; i<41; i++){
        Sleep (1000);}
    gEX = "RumbleverseClient-Win64-Shipping.exe";
